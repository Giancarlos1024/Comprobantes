<?php 
	...
	class Login extends Controllers{
		...
		{
			$data['page_tag'] = "Login - Contax Sis Web";
			$data['page_title'] = "Coantax Sis Web";
				...
				if (empty($_POST['txtEmail']) || empty($_POST['txtPassword'])) {
					...
					if (empty($requestUser)) {
						...
						if ($arrData['status'] == 1) {
							...
							// Agregar el idpersona a la respuesta
							$arrResponse = array('status' => true, 'msg' => 'ok', 'userId' => $arrData['idpersona']);
						} else {
